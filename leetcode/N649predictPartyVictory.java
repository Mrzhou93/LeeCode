    ...
    public String predictPartyVictory(String senate) {
        ...
        while(!RQueue.isEmpty() && !DQueue.isEmpty()){
            ...
            if (RQueue.peek() > DQueue.peek()){
                DQueue.add(DQueue.poll() + len);
                RQueue.remove();
            } else {
                RQueue.add(RQueue.poll() + len);
                DQueue.remove();
            }
        }
        ...
        System.out.println("RQueueSize="+RQueue.size());
        System.out.println("DQueueSize="+DQueue.size());

        return RQueue.isEmpty()? "Dire":"Radiant";
    }

    public static void main(String [] args){
        N649predictPartyVictory s = new N649predictPartyVictory();

        System.out.println(s.predictPartyVictory("RD").equals("Radiant"));
        System.out.println(s.predictPartyVictory("RDD").equals("Dire"));
        System.out.println(s.predictPartyVictory("DDRRRR").equals("Radiant"));
