...
class N1348TweetCounts {

    private Map<String, List<Integer>> map;

    public N1348TweetCounts() {
        map = new HashMap<>();
    }
    ...
    public List<Integer> getTweetCountsPerFrequency(String freq, String tweetName, int startTime, int endTime) {
        ...
        int[] ans = new int[((endTime - startTime) / delta) + 1];
...
//        System.out.println(list);
        for (int tweetTime: list){
            if (startTime <= tweetTime && tweetTime <= endTime){
                ans[(tweetTime - startTime) / delta]++;
            }
        }
...
//        System.out.println(ansList);
    ...
    public static void main(String[] args) {
        N1348TweetCounts tweetCounts = new N1348TweetCounts();
        ...
        tweetCounts = new N1348TweetCounts();

        tweetCounts.recordTweet("t0", 13);
        tweetCounts.recordTweet("t1", 16);
        tweetCounts.recordTweet("t2", 12);
        tweetCounts.recordTweet("t3", 18);
        tweetCounts.recordTweet("t4", 82);
        tweetCounts.recordTweet("t3", 89);
        tweetCounts.getTweetCountsPerFrequency("day", "t0", 89, 9471);
        tweetCounts.getTweetCountsPerFrequency("hour", "t3", 13, 4024);
    }
}
